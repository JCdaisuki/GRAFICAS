...
namespace PAG
{
    ...
    void Renderer::InicializarLuces()
    {
        ...
        lights.push_back(new Light(Light::LightType::Direccional, glm::vec3(1.0f), glm::vec3(1.0f), glm::vec3(0.0f), glm::vec3(0.0f, 0.0f, -1.0f)));
        lights.push_back(new Light(Light::LightType::Foco, glm::vec3(1.0f), glm::vec3(1.0f), glm::vec3(0.0f, 10.0f, 0.0f), glm::vec3(0.0f, -1.0f, 0.0f))); 
    }
    ...
    void Renderer::EstablecerLucesModel(Model *model, Light *light, GLuint* indices, GLuint idSP)
    {
        ...
        {
            glUniform3fv(glGetUniformLocation(idSP, "lightPosition"), 1, glm::value_ptr(light->GetPosicion()));
