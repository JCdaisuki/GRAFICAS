...
namespace PAG
{
    ...
    void Model::loadModel(std::string path)
    {
        ...
        const aiScene *scene = import.ReadFile(path, aiProcess_JoinIdenticalVertices | aiProcess_Triangulate | aiProcess_GenSmoothNormals);
    ...
    void Model::DibujarTextura(GLuint idSP)
    {
        glActiveTexture(GL_TEXTURE0);
        glBindTexture(GL_TEXTURE_2D, textureID);
        glUniform1i(glGetUniformLocation(idSP, "texture1"), 0);
    }
